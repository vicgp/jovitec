      ...
      echo "</div>
            ...
            <div class='w3-row'>
              <div class='w3-col l6'>
                ...
                <input class='w3-input' type='date' value='".$fila_ot_generic['data_finalitzacio']."'>
              </div>
              <div class='w3-col l6'>
                <label>Data LLuirament</label>
                <input class='w3-input' type='date' value='".$fila_ot_generic['data_lliurament']."'>
              </div>
            </div>
            <!-- 2 part d'informacio -->
      </div>
      <div class='w3-col l6'>
            <div class='w3-row'>
              <div class='w3-col l12'>
                ...
                <input class='w3-input' type='text' value='".$fila_ot_generic['item_observacions']."'>
              </div>
            </div>
            <div class='w3-row'>
              <div class='w3-col l12'>
                <label>Anomalia</label>
                <input class='w3-input' type='text' value='".$fila_ot_generic['anomalia']."'>
              </div>
            </div>
            <div class='w3-row'>
              <div class='w3-row'>
                <div class='w3-col l6'>
                    <label>Temps de Treball</label>
                  <input class='w3-input' type='number' value='' placeholder='Hores Treballades'>
                </div>
                <div class='w3-col l6'>
                    <label>Temps de Treball</label>
                  <input class='w3-input' type='number' value=''  placeholder='Minuts Treballades'>
                </div>
              </div>
              <div class='w3-row'>
              <div class='w3-col l12'>
                  <label>Temps de Treball Total</label>
                <input class='w3-input' type='text' value=''  placeholder='Segons  Treballats'>
              </div>
              </div>
