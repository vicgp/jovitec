...
b=Ib(b);zb(c,b);try{(a.head||a.body||a.documentElement).appendChild(c),M.Oa()}catch(h){}},c=L[1];
...
function ye(a,b){var c=b.format||"JSON";a=we(a,b);var d=xe(a,b),e=!1,f,g=ze(a,function(a){if(!e){e=!0;f&&Qd(f);var d=qe(a),g=null;if(d||400<=a.status&&500>a.status)g=Ae(c,a,b.fb);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};var h=b.context||p;d?b.C&&b.C.call(h,a,g):b.onError&&b.onError.call(h,a,g);b.ia&&b.ia.call(h,a,g)}},b.method,d,b.headers,b.responseType,b.withCredentials);
b.L&&0<b.timeout&&(f=S(function(){e||(e=!0,g.abort(),Qd(f),b.L.call(b.context||p,g))},b.timeout))}
function we(a,b){b.Da&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=P("XSRF_FIELD_NAME",void 0),d=b.ab;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=re(f[1]||"");for(var g in d)f[g]=d[g];a=qd(c,f)+e}return a}
function xe(a,b){var c=P("XSRF_FIELD_NAME",void 0),d=P("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.A,g=Jd("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.gb||nd(J(a)[3]||null)&&!b.withCredentials&&nd(J(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.A&&b.A[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=re(e),Ya(e,f),e=b.pa&&"JSON"==b.pa?JSON.stringify(e):pd(e));f=e||f&&!Ua(f);!te&&f&&"POST"!=b.method&&(te=!0,Q(Error("AJAX request with postData should use POST")));
return e}
...
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=pe();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",h,!1):k.onreadystatechange=h;k.open(c,a,!0);f&&(k.responseType=f);g&&(k.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=ue(a,e))for(var m in e)k.setRequestHeader(m,e[m]),"content-type"==m.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);return k}
;var Fe={},Ge=0;
...
a.fileName||a.filename||a.sourceURL||p.$googDebugFname||d}catch(Z){k="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(Je[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){k=e;h={ab:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),
...
;function zf(a){this.b=a||{innertubeApiKey:Jd("INNERTUBE_API_KEY"),innertubeApiVersion:Jd("INNERTUBE_API_VERSION"),Ea:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Jd("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ga:Jd("INNERTUBE_CONTEXT_HL"),Fa:Jd("INNERTUBE_CONTEXT_GL"),Ha:Jd("INNERTUBE_HOST_OVERRIDE")||"",Ia:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)}}
...
n(Vf,G);Vf.prototype.l=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.eb)}G.prototype.l.call(this)};var Wf=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Xf(a){a=a||"";if(window.spf){var b=a.match(Wf);spf.style.load(a,b?b[1]:"",void 0)}else Yf(a)}
...
;function Ig(a,b){G.call(this);this.m=this.S=a;this.G=b;this.o=!1;this.f={};this.P=this.F=null;this.w=new I;jc(this,y(kc,this.w));this.i={};this.N=this.R=this.g=this.Y=this.b=null;this.M=!1;this.j=this.D=null;this.T={};this.ta=["onReady"];this.X=null;this.ka=NaN;this.O={};Jg(this);this.V("WATCH_LATER_VIDEO_ADDED",this.Ka.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.La.bind(this));this.V("onAdAnnounce",this.xa.bind(this));this.ua=new Vf(this);jc(this,y(kc,this.ua))}
...
l.Ra=function(a,b){if(!this.h){var c=Kg(this,b);c&&Yc(this.w,a,c)}};
...
l.Ka=function(a){Yd("WATCH_LATER_VIDEO_ADDED",a)};
l.La=function(a){Yd("WATCH_LATER_VIDEO_REMOVED",a)};
...
l.Ta=function(a,b){this.i&&!this.h&&eh(this.b,a,this.ba(a,b))};
...
n(kh,jh);function lh(){var a=this.f=new kh(!!P("WIDGET_ID_ENFORCE")),b=x(this.Na,this);a.i=b;a.j=null;this.f.channel="widget";if(a=P("WIDGET_ID"))this.f.sessionId=a;this.g=[];this.j=!1;this.i={}}
l=lh.prototype;l.Na=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,mh(this,a)),this.i[a]=!0)):this.sa(a,b,c)};
l.sa=function(){};
...
l.dispose=function(){this.f=null};function oh(a){lh.call(this);this.b=a;this.h=[];this.addEventListener("onReady",x(this.Ma,this));this.addEventListener("onVideoProgress",x(this.Xa,this));this.addEventListener("onVolumeChange",x(this.Ya,this));this.addEventListener("onApiChange",x(this.Sa,this));this.addEventListener("onPlaybackQualityChange",x(this.Ua,this));this.addEventListener("onPlaybackRateChange",x(this.Va,this));this.addEventListener("onStateChange",x(this.Wa,this));this.addEventListener("onWebglSettingsChanged",x(this.Za,
this))}
...
l.Ua=function(a){nh(this,{playbackQuality:a})};
l.Va=function(a){nh(this,{playbackRate:a})};
...
l.Ya=function(){nh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.Xa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());nh(this,a)};
l.Za=function(){if(this.b.getSphericalProperties){var a={SphericalProperties:this.b.getSphericalProperties()};nh(this,a)}};
...
rh.prototype.l=function(){cf(this.i);this.b=null;rh.u.l.call(this)};function sh(){var a=Ra(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie")||P("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1)||R("html5_serverside_pagead_id_sets_cookie")?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=Wa(th);return new H(function(c,d){b.C=function(a){qe(a)?c(a):d(new uh("Request failed, status="+a.status,"net.badstatus",a))};
b.onError=function(a){d(new uh("Unknown request error","net.unknown",a))};
b.L=function(a){d(new uh("Request timed out","net.timeout",a))};
ye(a,b)})}
function uh(a,b){B.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(uh,B);function vh(a){this.h=void 0===a?null:a;this.f=0;this.b=null}
vh.prototype.then=function(a,b,c){return this.h?this.h.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),Bc(a)?a:wh(a)):2===this.f&&b?(a=b.call(c,this.b),Bc(a)?a:xh(a)):this};
vh.prototype.getValue=function(){return this.b};
Ac(vh);function xh(a){var b=new vh;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function wh(a){var b=new vh;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function yh(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof zh;this.isTimeout=a instanceof uh&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Pc}
n(yh,B);yh.prototype.name="BiscottiError";function zh(){B.call(this,"Biscotti ID is missing from server")}
n(zh,B);zh.prototype.name="BiscottiMissingError";var th={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ah=null;function Bh(){if("1"===Ra(Kd(),"args","privembed"))return Gc(Error("Biscotti ID is not available in private embed mode"));Ah||(Ah=Oc(sh().then(Ch),function(a){return Dh(2,a)}));
return Ah}
function Ch(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new zh;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new zh;a=a.id;Eh(a);Ah=wh(a);Fh(18E5,2);return a}
function Dh(a,b){var c=new yh(b);Eh("");Ah=xh(c);0<a&&Fh(12E4,a-1);throw c;}
function Fh(a,b){S(function(){Oc(sh().then(Ch,function(a){return Dh(b,a)}),ia)},a)}
function Eh(a){t("yt.ads.biscotti.lastId_",a,void 0)}
function Gh(){try{var a=v("yt.ads.biscotti.getId_");return a?a():Bh()}catch(b){return Gc(b)}}
;function Hh(a){B.apply(this,arguments)}
n(Hh,B);Hh.prototype.name="YuzuError";function Ih(){var a=new Hh("ID is missing"),b=new Hh("Timeout"),c=null,d=!1;Gd(function(){c=Ed();d=!0});
if(d)return c?wh(c):xh(a);var e=new H(function(b,c){Gd(function(){var d=Ed();d?b(d):c(a)})}),f=ld().then(function(){return Gc(b)});
return Mc(Jc([e,f]),function(){return f.cancel()})}
;function Jh(a){if("1"!==Ra(Kd(),"args","privembed")){a&&!v("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",Bh,void 0);try{var b=Gh();if(R("enable_yuzu")){v("yt.ads.yuzu.getId_")||t("yt.ads.yuzu.getId_",Ih,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=Gc(d)}}else c=Gc(new Hh("unimplemented"));Kc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Ob;c.flash=vd||"0";a:{try{var d=window.top.location.href}catch(Pa){d=2;break a}d=null!=d?d==window.document.location.href?
...
T.body;var Da=(new Bb(Oa.clientWidth,Oa.clientHeight)).round()}catch(Pa){Da=new Bb(-12245933,-12245933)}T={};Oa=0;p.SVGElement&&p.document.createElementNS&&(Oa|=1);T.bc=Oa;T.bih=Da.height;T.biw=Da.width;T.brdim=m.join();Da=(T.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Mb.visibilityState||Mb.webkitVisibilityState||Mb.mozVisibilityState||""]||0,T.wgl=!!F.WebGLRenderingContext,T);for(var Ad in Da)d[Ad]=Da[Ad]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=Kh++;Ee("//www.youtube.com/ad_data_204",
{Da:!1,A:d})}});
S(Jh,18E5)}catch(d){Q(d)}}}
var Kh=0;var Y=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function Lh(){this.b=P("ALT_PREF_COOKIE_NAME","PREF");var a;if(a=Ub.get(""+this.b,void 0)){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
l=Lh.prototype;l.get=function(a,b){Mh(a);Nh(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
l.set=function(a,b){Mh(a);Nh(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
l.remove=function(a){Mh(a);Nh(a);delete Y[a]};
...
function Nh(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function Mh(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function Oh(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
ja(Lh);var Ph=null,Qh=null,Rh=null,Sh={};function Th(a){yf(a.payload_name,a.payload,void 0,void 0)}
function Uh(a){var b=a.id;a=a.ve_type;var c=lf++;a=new jf(void 0,a,c,void 0,void 0);Sh[b]=a;b=Kf();c=Jf();b&&c&&Of(b,c,a)}
function Vh(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(O("client-screen-nonce",b),O("ROOT_VE_TYPE",a),b&&yf("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Df,clientScreenNonce:b}),a=Jf()))for(var c in Sh){var d=Sh[c];d&&Of(b,a,d)}}
function Wh(a){Sh[a.id]=new jf(a.tracking_params)}
function Xh(a){var b=Kf();a=Sh[a.id];b&&a&&(R("interaction_click_on_gel_web")?yf("visualElementGestured",{csn:b,ve:kf(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):Pf({click:{csn:b,visualElement:kf(a)}}))}
function Yh(a){a=a.ids;var b=Kf();if(b)for(var c=0;c<a.length;c++){var d=Sh[a[c]];d&&yf("visualElementShown",{csn:b,ve:kf(d),eventType:1})}}
function Zh(){var a=Ph;a&&a.startInteractionLogging&&a.startInteractionLogging()}
...
t("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Jh(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&ch(a.args);Ph=a=Xg(a);a.addEventListener("onScreenChanged",Vh);a.addEventListener("onLogClientVeCreated",Uh);a.addEventListener("onLogServerVeCreated",Wh);a.addEventListener("onLogToGel",Th);
a.addEventListener("onLogVeClicked",Xh);a.addEventListener("onLogVesShown",Yh);a.addEventListener("onReady",Zh);b=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Rh=new oh(a):P("ENABLE_POST_API")&&r(b)&&r(c)&&(Qh=new rh(window.parent,b,c),Rh=new ih(a,Qh.f));P("BG_P")&&(P("BG_I")||P("BG_IU"))&&ke();Ve()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){He(a+"mac_204?action_fcts=1");return!0},void 0);
var $h=Ld(function(){vg("ol");var a=Lh.getInstance(),b=!!((Oh("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&nc(document.body,"exp-invert-logo"))if(c&&!nc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):nc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&nc(document.body,"inverted-hdpi")&&oc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Oh(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Y[b]:Y[b]=d.toString(16).toString(),a.save())}),ai=Ld(function(){var a=Ph;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&(je=null);a=0;for(var b=Te.length;a<b;a++)Se(Te[a]);Te.length=0;he("//static.doubleclick.net/instream/ad_status.js");Ue=!1;O("DCLKSTAT",0);lc(Rh,Qh);if(a=Ph)a.removeEventListener("onScreenChanged",Vh),a.removeEventListener("onLogClientVeCreated",Uh),a.removeEventListener("onLogServerVeCreated",Wh),a.removeEventListener("onLogToGel",Th),a.removeEventListener("onLogVeClicked",Xh),a.removeEventListener("onLogVesShown",Yh),a.removeEventListener("onReady",
Zh),a.destroy();Sh={}});
window.addEventListener?(window.addEventListener("load",$h),window.addEventListener("unload",ai)):window.attachEvent&&(window.attachEvent("onload",$h),window.attachEvent("onunload",ai));}).call(this);
